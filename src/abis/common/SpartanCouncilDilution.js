	...
	abi: [
		...
		},
		{
			...
			inputs: [
				...
				{ indexed: false, internalType: 'uint256', name: 'totalDilutionValueBefore', type: 'uint256' },
				{ indexed: false, internalType: 'uint256', name: 'totalDilutionValueAfter', type: 'uint256' },
			],
		...
		},
		{
			...
			inputs: [
				...
				{ indexed: false, internalType: 'address[]', name: 'nominatedCouncilMembers', type: 'address[]' },
				...
				{ indexed: false, internalType: 'uint256[]', name: 'assignedVoteWeights', type: 'uint256[]' },
			],
			name: 'ElectionLogged',
			type: 'event',
		},
		...
		},
		{
			anonymous: false,
			inputs: [
				{ indexed: false, internalType: 'uint256', name: 'previousProposalPeriod', type: 'uint256' },
